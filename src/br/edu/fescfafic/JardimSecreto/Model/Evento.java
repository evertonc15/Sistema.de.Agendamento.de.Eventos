...
public class Evento {
    ...
    public Evento(int idDoEvento, String organizadorDoEvento, String nomeDoEvento, LocalDate dataDoEvento, LocalTime horaDoEvento, String localDoEvento, int capacidadeTotalDoEvento, int participantesRegistrados){
    ...
    public void exibirInfo(){
        ...
        System.out.printf("\nCapacidade do Evento - %d", capacidadeTotalDoEvento);
    }
}
